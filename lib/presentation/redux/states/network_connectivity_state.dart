...
class NetworkConnectivityState extends LinShareState with EquatableMixin {
  ...
  NetworkConnectivityState setNetworkState(ConnectivityResult connectivityResult) {
    return NetworkConnectivityState(viewState, connectivityResult);
  }

  @override
  NetworkConnectivityState clearViewState() {
    return NetworkConnectivityState(Right(IdleState()), connectivityResult);
  }
