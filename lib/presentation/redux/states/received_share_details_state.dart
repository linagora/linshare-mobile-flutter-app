...
class ReceivedShareDetailsState extends LinShareState with EquatableMixin {
  ...
  @override
  ReceivedShareDetailsState sendViewState({Either<Failure, Success> viewState}) {
  ...
  ReceivedShareDetailsState setReceivedShare({Either<Failure, Success> viewState, ReceivedShare newReceivedShare}) {
