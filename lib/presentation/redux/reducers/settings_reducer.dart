...
final settingsReducer = combineReducers<SettingsState>([
  TypedReducer<SettingsState, GetAppModeSucceededAction>(
    (SettingsState state, GetAppModeSucceededAction action) =>
      state.setAppMode(
        appMode: action.viewState
          .getOrElse(() => GetAppModeSettingsSuccess(AppMode.None))
          .appMode,
