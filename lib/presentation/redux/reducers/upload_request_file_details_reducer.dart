...
final uploadRequestFileDetailsReducer = combineReducers<UploadRequestFileDetailsState>([
  TypedReducer<UploadRequestFileDetailsState, StartUploadRequestFileDetailsLoadingAction>((UploadRequestFileDetailsState state, _) => state.startLoadingState()),
  TypedReducer<UploadRequestFileDetailsState, UploadRequestFileDetailsAction>((UploadRequestFileDetailsState state, UploadRequestFileDetailsAction action) => state.sendViewState(viewState: action.viewState)),
