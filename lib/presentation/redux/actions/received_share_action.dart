...
@immutable
class StartReceivedShareLoadingAction extends ActionOnline {}

@immutable
class ReceivedShareAction extends ActionOffline {
  final Either<Failure, Success> viewState;

  ReceivedShareAction(this.viewState);
}

@immutable
class ReceivedShareGetAllReceivedSharesAction extends ActionOnline {
  final Either<Failure, Success> viewState;

  ReceivedShareGetAllReceivedSharesAction(this.viewState);
}
