...
class UploadAndShareFileStateList {
  final int completedMaxSize;
  ...
  void _minimizeCompletedFiles() {
    while (_completedFiles().length > completedMaxSize) {
      _priorityRemoveCompletedFiles(_completedFiles())
          .take(reduceCompletedSize)
          .forEach((removeElement) {
            _uploadingStateFiles.remove(removeElement);
          });
    }
  }
