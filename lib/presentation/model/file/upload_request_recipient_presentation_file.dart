...
class UploadRequestPresentationFile extends Equatable implements PresentationFile {
  ...
  UploadRequestPresentationFile(this.label, this.collective, {this.usedSpace = 0});
