...
class OrderByDialogBottomSheetBuilder {
  ...
  OrderByDialogBottomSheetBuilder onSelectSorterAction(
      OnSelectSorterAction onSelectSorterAction)
  {
    _onSelectSorterAction = onSelectSorterAction;
    return this;
  }

  List<Widget> build() {
    return _currentSorter
        .getListSorter(_currentSorter.orderScreen)
        .map((sorter) => _sorterTileAction(_context, Sorter.fromSorter(sorter, _currentSorter), _currentSorter))
        .toList();
  }
