...
class SharedSpaceMultipleSelectionActionBuilder extends MultipleSelectionActionBuilder<List<SharedSpaceNodeNested>> {
  final List<SharedSpaceNodeNested> _sharedSpaces;

  SharedSpaceMultipleSelectionActionBuilder(
    Key key,
