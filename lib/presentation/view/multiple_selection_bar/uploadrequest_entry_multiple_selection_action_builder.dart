...
class UploadRequestEntryMultipleSelectionActionBuilder extends MultipleSelectionActionBuilder<List<UploadRequestEntry>> {
  final List<UploadRequestEntry> _entries;

  UploadRequestEntryMultipleSelectionActionBuilder(
    Key key,
    ...
    return IconButton(
      ...
      onPressed: () {
        if (onMultipleSelectionActionClick != null) {
          onMultipleSelectionActionClick!(_entries);
        }
      }
    );
  }
