...
class ReceivedShareMultipleSelectionActionBuilder extends MultipleSelectionActionBuilder<List<ReceivedShare>> {
  final List<ReceivedShare> _receivedShares;

  ReceivedShareMultipleSelectionActionBuilder(
    Key key,
    SvgPicture actionIcon,
    this._receivedShares
