...
class UploadRequestGroupMultipleSelectionActionBuilder extends MultipleSelectionActionBuilder<List<UploadRequestGroup>> {
  final List<UploadRequestGroup> _groups;
    ...
    return IconButton(
      ...
      onPressed: () {
        if (onMultipleSelectionActionClick != null) {
          onMultipleSelectionActionClick!(_groups);
        }
      }
    );
  }
