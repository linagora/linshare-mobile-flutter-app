...
class MoreActionBottomSheetHeaderBuilder {
  final Key _key;
  final List<PresentationFile> _files;
  final BuildContext _buildContext;

  MoreActionBottomSheetHeaderBuilder(this._buildContext, this._key, this._files);

  ListTile build() {
    return ListTile(
        key: _key,
        title: Text(
          AppLocalizations.of(_buildContext).items_selected(_files.length),
          maxLines: 1,
          style: TextStyle(
