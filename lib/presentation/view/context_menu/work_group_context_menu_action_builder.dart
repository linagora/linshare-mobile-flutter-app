...
class WorkgroupContextMenuTileBuilder extends ContextMenuActionBuilder<SharedSpaceNodeNested> {
  final SharedSpaceNodeNested _sharedSpaceNodeNested;

  WorkgroupContextMenuTileBuilder(
    Key key,
    SvgPicture actionIcon,
    String actionName,
    this._sharedSpaceNodeNested
  ...
  ListTile build() {
    return ListTile(
      ...
      onTap: () => onContextMenuActionClick(_sharedSpaceNodeNested)
    );
  }
}