  ...
  Widget _buildFormEditUploadRequestGroup(EditUploadRequestState state) {
    return (UploadRequestViewBuilder(context, EditUploadRequestType.group)
        ...
        ..addEmailMessageInput((EmailMessageInputFieldBuilder(context)
            ...
            .build())
        ..addActivationDateInput(state.uploadRequest?.activationSetting != null
            ? state.uploadRequest?.status == UploadRequestStatus.ENABLED
                ...
                : (DateTimeInputFieldBuilder()
                    ...
                    .build()
            : null)
        ..addExpirationDateInput(state.uploadRequest?.expirationSetting != null
            ? (DateTimeInputFieldBuilder()
              ...
              .build()
            : null)
        ..addMaxNumberFileInput(state.uploadRequest?.maxFileCountSetting != null
            ? (NumberInputFieldBuilder(context)
              ...
              .build()
            : null)
        ..addMaxSizeFileInput(state.uploadRequest?.maxFileSizeSetting != null
            ? (FileSizeInputFieldBuilder(context)
              ...
              .build()
            : null)
        ..addReminderDateInput(state.uploadRequest?.notificationSetting != null
            ? (DateTimeInputFieldBuilder()
              ...
              .build()
            : null)
        ..addTotalSizeFileInput(state.uploadRequest?.totalFileSizeSetting != null
            ? (FileSizeInputFieldBuilder(context)
              ...
              .build()
            : null)
        ..addPasswordProtectedNoChangeInput(state.uploadRequest?.protectPasswordSetting != null
            ? (PairTextInputFieldBuilder()
              ...
              .build()
            : null)
        ..addAllowDeletionInput(state.uploadRequest?.canDeleteSetting != null
            ? (CheckboxInputFieldBuilder()
              ...
              .build()
            : null)
        ..addAllowClosureInput(state.uploadRequest?.canCloseSetting != null
            ? (CheckboxInputFieldBuilder()
