...
class _UploadRequestGroupWidgetState extends State<UploadRequestGroupWidget> {
        ...
        child: Scaffold(
          appBar: TabBar(
              ...
              tabs: [
                ...
                Tab(text: AppLocalizations.of(context).active_closed),
          ...
          body: StoreConnector<AppState, UploadRequestGroupState>(
            ...
            builder: (_, state) => TabBarView(
              children: [
                _buildSimpleUploadRequestListWidget(context, state.uploadRequestsCreatedList),
                _buildActiveClosedListWidget(context, state.uploadRequestsActiveClosedList),
                _buildSimpleUploadRequestListWidget(context, state.uploadRequestsArchivedList)
              ],
            ),
          ),
        ));
  ...
  Widget _buildSimpleUploadRequestListWidget(BuildContext context, List<UploadRequestGroup> uploadRequestList) {
    return RefreshIndicator(
        ...
        child: uploadRequestList.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) => _buildSimpleUploadTile(uploadRequestList[index])));
  }
  ...
  ListTile _buildSimpleUploadTile(UploadRequestGroup request) {
    return ListTile(
      dense: true,
