...
class _AddSharedSpaceMemberWidgetState extends State<AddRecipientsUploadRequestGroupWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StoreConnector<AppState, List<GenericUser>>(
          converter: (store) =>
              store.state.addRecipientsUploadRequestGroupState.currentRecipientsSet.toList(),
          builder: (context, currentRecipientsList) =>
              _buildRecipientsWidget(context, currentRecipientsList)),
            ...
            return IgnorePointer(
              ...
              child: FloatingActionButton.extended(
                  ...
                  onPressed: () => _model.sendRecipientsList(
                      arguments.uploadRequestGroup.uploadRequestGroupId, recipientsList),
                  label: Text(
  ...
  Widget _buildRecipientsWidget(
      BuildContext buildContext, List<GenericUser> currentRecipientsList) {
    return Container(
        ...
        children: [
          ...
          TypeAheadFormField(
              ...
              suggestionsCallback: (pattern) async {
                if (pattern.length >= 3) {
                  return (await _model.getAutoCompleteSharing(pattern)).where((autoComplete) =>
