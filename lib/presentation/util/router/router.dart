...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case RoutePaths.signUpRoute:
      return MaterialPageRoute(builder: (context) => getIt<SignUpWidget>(), settings: settings);
    ...
    case RoutePaths.addSharedSpaceNodeMember:
      return MaterialPageRoute(builder: (context) => getIt<AddSharedSpaceNodeMemberWidget>(), settings: settings);
    ...
    case RoutePaths.uploadRequestRecipientDetails:
      ...
      case RoutePaths.uploadRequestFileDetails:
      return MaterialPageRoute(builder: (context) => getIt<UploadRequestFileDetailsWidget>(), settings: settings);
    ...
    case RoutePaths.audioRecorder:
      return TransparentPageRoute(builder: (context) => getIt<RecordAudioWidget>(), settings: settings);
