...
// more details.
// You should have received a copy of the GNU Affero Genera l Public License and its
...
import 'package:domain/src/repository/autocomplete/autocomplete_repository.dart';

class GetAutoCompleteSharingInteractor {
  final AutoCompleteRepository _autoCompleteRepository;

  GetAutoCompleteSharingInteractor(this._autoCompleteRepository);
