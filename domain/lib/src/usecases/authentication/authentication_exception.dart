...
class ServerNotFound extends AuthenticationException {
  ServerNotFound() : super(AuthenticationException.serverNotFound);
}

class UnknownError extends AuthenticationException {
  UnknownError(String message) : super(message);
}

class ConnectError extends AuthenticationException {
  ConnectError() : super(AuthenticationException.connectError);
}
