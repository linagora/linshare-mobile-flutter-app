...
class DownloadPreviewReceivedShareFailure extends FeatureFailure {
  final downloadPreviewException;

  DownloadPreviewReceivedShareFailure(this.downloadPreviewException);

  @override
  List<Object> get props => [downloadPreviewException];
}

class NoReceivedSharePreviewAvailable extends FeatureFailure {

  NoReceivedSharePreviewAvailable();
