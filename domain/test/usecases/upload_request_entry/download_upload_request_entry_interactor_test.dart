...
import 'download_upload_request_entry_interactor_test.mocks.dart';

@GenerateMocks([UploadRequestEntryRepository, TokenRepository, CredentialRepository, APIRepository])
void main() {
