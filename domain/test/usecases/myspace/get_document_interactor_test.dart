...
import 'get_document_interactor_test.mocks.dart';
...
void main() {
  group('get_document_interactor_test', () {
    ...
    setUp(() {
      ...
      getDocumentInteractor = GetDocumentInteractor(documentRepository);
    });
    ...
    test('get document should return success with valid data', () async {
      ...
      result.fold(
          (failure) => null,
          (success) {
            expect(success, isA<GetDocumentViewState>());
            expect(documentDetails1, (success as GetDocumentViewState).document);
      });
    });
    ...
    test('get document should return failure', () async {
      ...
      final result = await getDocumentInteractor.execute(documentDetails1.documentId);
      result.fold(
          (failure) => expect(failure, isA<GetDocumentFailure>()),
          (success) => null);
    });
  });
}