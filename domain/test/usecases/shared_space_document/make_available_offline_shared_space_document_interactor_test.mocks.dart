...
// in domain/test/usecases/shared_space_document/make_available_offline_shared_space_document_interactor_test.dart.
...
class _FakeToken_3 extends _i1.Fake implements _i3.Token {}
...
class MockTokenRepository extends _i1.Mock implements _i2.TokenRepository {
  ...
  _i4.Future<_i3.Token> getToken() =>
      (super.noSuchMethod(Invocation.method(#getToken, []),
              returnValue: Future<_i3.Token>.value(_FakeToken_3()))
...
class MockCredentialRepository extends _i1.Mock
  ...
  _i4.Future<Uri> getBaseUrl() =>
      (super.noSuchMethod(Invocation.method(#getBaseUrl, []),
          returnValue: Future<Uri>.value(_FakeUri_4())) as _i4.Future<Uri>);
}
