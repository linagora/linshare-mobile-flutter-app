...
void getAvailableBiometric() {
  group('biometric_data_source_impl getAvailableBiometrics test', () {
    ...
    test('getAvailableBiometrics should return success with valid data', () async {
      ...
      when(_localAuthenticationService.getAvailableBiometrics()).thenAnswer((_) async => [BiometricType.face, BiometricType.fingerprint]);

      final biometricKinds = await _biometricDataSourceImpl.getAvailableBiometrics();

      expect(biometricKinds, [BiometricType.face.getBiometricKind(), BiometricType.fingerprint.getBiometricKind()]);
    });

    test('getAvailableBiometrics should throw PlatformException when _localAuthenticationService response error', () async {
      await _initDataSource();
      ...
      when(_localAuthenticationService.getAvailableBiometrics()).thenThrow(error);
...
void authenticate() {
  group('biometric_data_source_impl authenticate test', () {
    ...
    test('authenticate should return success with valid data', () async {
      ...
      when(_localAuthenticationService.authenticate('Please authenticate to open app')).thenAnswer((_) async => true);
    ...
    test('authenticate should throw PlatformException when _localAuthenticationService response error', () async {
      await _initDataSource();
      ...
      when(_localAuthenticationService.authenticate('Please authenticate to open app')).thenThrow(error);
