...
import 'package:data/src/local/converter/share_id_converter.dart';
import 'package:domain/domain.dart';
import 'package:equatable/equatable.dart';
import 'package:http_parser/http_parser.dart';
import 'package:json_annotation/json_annotation.dart';

part 'received_share_cache.g.dart';
...
class ReceivedShareCache with EquatableMixin {
  ...
  Map<String, dynamic> toJson() => _$ReceivedShareCacheToJson(this);
}

extension ReceivedShareCacheExtensions on ReceivedShareCache {
  ReceivedShare toReceivedShare() => ReceivedShare(
    shareId,
    name,
    creationDate,
    modificationDate,
    expirationDate,
    description,
    recipientMail != null ? GenericUser(recipientMail!, lastName: optionOf(recipientLastName), firstName: optionOf(recipientFirstName)) : null,
    mediaType,
