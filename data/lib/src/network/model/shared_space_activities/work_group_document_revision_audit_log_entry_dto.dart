...
class WorkGroupDocumentRevisionAuditLogEntryDto extends AuditLogEntryUserDto {
  ...
  WorkGroupDocumentRevisionAuditLogEntryDto(
  ...
  factory WorkGroupDocumentRevisionAuditLogEntryDto.fromJson(Map<String, dynamic> json) => _$WorkGroupDocumentRevisionAuditLogEntryDtoFromJson(json);
  Map<String, dynamic> toJson() => _$WorkGroupDocumentRevisionAuditLogEntryDtoToJson(this);
}

extension WorkGroupDocumentRevisionAuditLogEntryDtoExtension on WorkGroupDocumentRevisionAuditLogEntryDto {
  WorkGroupDocumentRevisionAuditLogEntry toWorkGroupDocumentRevisionAuditLogEntry() => WorkGroupDocumentRevisionAuditLogEntry(
      auditLogEntryId,
      resourceId,
      fromResourceId,
      creationDate,
