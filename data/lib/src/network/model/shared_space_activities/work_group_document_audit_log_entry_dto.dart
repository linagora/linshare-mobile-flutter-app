...
part 'work_group_document_audit_log_entry_dto.g.dart';

@JsonSerializable()
@DatetimeNullableConverter()
@AuditLogEntryIdConverter()
@AuditLogResourceIdConverter()
class WorkGroupDocumentAuditLogEntryDto extends AuditLogEntryUserDto {

  final WorkGroupLightDto workGroup;
  final WorkGroupDocumentDto resource;
  final WorkGroupDocumentDto resourceUpdated;
  final WorkGroupCopyDto copiedTo;
  final WorkGroupCopyDto copiedFrom;

  WorkGroupDocumentAuditLogEntryDto(
  ...
  factory WorkGroupDocumentAuditLogEntryDto.fromJson(Map<String, dynamic> json) => _$WorkGroupDocumentAuditLogEntryDtoFromJson(json);
  Map<String, dynamic> toJson() => _$WorkGroupDocumentAuditLogEntryDtoToJson(this);
}

extension WorkGroupDocumentAuditLogEntryDtoExtension on WorkGroupDocumentAuditLogEntryDto {
  WorkGroupDocumentAuditLogEntry toWorkGroupDocumentAuditLogEntry() => WorkGroupDocumentAuditLogEntry(
      auditLogEntryId,
      resourceId,
      fromResourceId,
