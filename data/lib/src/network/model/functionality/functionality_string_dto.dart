...
part 'functionality_string_dto.g.dart';
...
class FunctionalityStringDto extends FunctionalityDto with EquatableMixin {
  ...
  factory FunctionalityStringDto.fromJson(Map<String, dynamic> json) => _$FunctionalityStringDtoFromJson(json);
...
extension FunctionalityStringDtoExtension on FunctionalityStringDto {
  FunctionalityString toFunctionalityString() =>
      FunctionalityString(identifier, enable ?? false, canOverride ?? false, value ?? '');
}
