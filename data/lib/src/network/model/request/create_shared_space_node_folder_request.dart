...
class CreateSharedSpaceNodeFolderRequest {
  ...
  factory CreateSharedSpaceNodeFolderRequest.fromJson(Map<String, dynamic> json) => _$CreateSharedSpaceNodeFolderRequestFromJson(json);

  Map<String, dynamic> toJson() {
    if (parentWorkGroupNodeId == null) {
      return {jsonEncode('name'): jsonEncode(name), jsonEncode('type'): jsonEncode(type.value)};
    } else {
      return {
