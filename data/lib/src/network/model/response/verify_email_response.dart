...
class VerifyEmailResponse with EquatableMixin {

  final bool isEmailAvailable;

  VerifyEmailResponse(this.isEmailAvailable);
...
extension VerifyEmailResponseExtension on VerifyEmailResponse {
  bool isEmailValid() => isEmailAvailable;
}