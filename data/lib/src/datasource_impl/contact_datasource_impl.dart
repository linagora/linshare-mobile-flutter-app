...
import 'package:data/src/datasource/contact_datasource.dart';
import 'package:domain/domain.dart';
import 'package:domain/src/model/autocomplete/autocomplete_pattern.dart';
import 'package:domain/src/model/contact/contact.dart' as contact;

class ContactDataSourceImpl extends ContactDataSource {

  @override
  Future<List<contact.Contact>> getContactSuggestions(AutoCompletePattern autoCompletePattern) async {
    final suggestedList = await contact_service.ContactsService.getContactsByEmailOrName(autoCompletePattern.value);
